...
export const enscheduleContract = defineContract({
  ...
  listGroups: {
    ...
    path: "/groups",
    headers: AuthHeadersSchema,
    responses: { [Status.OK]: z.array(GroupSchema) },
    errorResponses,
  },
  createGroup: {
    type: "standard",
    ...
    responses: { [Status.Created]: GroupSchema },
    errorResponses,
  },
  updateGroup: {
    type: "standard",
    ...
    responses: { [Status.OK]: GroupSchema },
    errorResponses,
  },
  deleteGroup: {
    type: "standard",
  ...
  accessDiagnostics: {
    type: "standard",
    method: "GET",
    path: "/admin/access-diagnostics",
    headers: AuthHeadersSchema,
    responses: { [Status.OK]: z.array(AccessDiagnosticSchema) },
    errorResponses,
  },
  listWorkers: {
    type: "standard",
