...
Set `ENSCHEDULE_NO_AUTH=true` to disable dashboard login and give every visitor API-key-level access. This mode requires `ENSCHEDULE_API_KEY` and should only be used for disposable demos without sensitive data.
